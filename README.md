...
кэшируется на шесть часов: у GitHub лимит 60 неавторизованных запросов в час на
адрес, а страница опрашивается регулярно. Кнопка «Проверить сейчас» спрашивает
GitHub немедленно, не дожидаясь конца кэша.
